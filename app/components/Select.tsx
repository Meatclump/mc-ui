...
export default ({placeholder, ariaLabel}: {placeholder: string, ariaLabel: string}) => {
	return (
		<SelectRoot>
			<SelectTrigger className="inline-flex items-center justify-between rounded px-2 text-base leading-none h-7 gap-2 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors duration-300 border border-slate-400 data-[placeholder]:text-slate-700 dark:data-[placeholder]:text-slate-300">
